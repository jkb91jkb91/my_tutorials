...
3) jak sprawdzic czy pody flux dzialaja >>   
```
kubectl get pods -n flux-system
```  
5) Jak sprawdzic czy FLUX widzi REPO >>   
```
 kubectl get gitrepositories -A
```
6) jesli helm file wstawiasz np do staging to musisz miec juz utworzony ten namespace   
7) pamietaj ze Kustomization tez musi dzialac >>  
```
...
```
to i tak zostanie przez Fluxa wyjebane po 10 minutach czy ilus tam   
